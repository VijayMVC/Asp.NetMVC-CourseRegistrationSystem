...
CREATE PROCEDURE pSelAvailableClassesForParticularStudent 
...
BEGIN
	...
	NOT IN (SELECT ClassStudents.ClassId FROM ClassStudents WHERE @StudentId = ClassStudents.StudentId)
END
GO
...
CREATE PROCEDURE pSelClassesForParticularStudent 
	-- Add the parameters for the stored procedure here
	@StudentId int = 0
AS
BEGIN
